...
root = os.path.join(args.signals_path, "clean_signals") #"/srv/local/data/physionet.org/files/chbmit/1.0.0/clean_signals"
out = os.path.join(args.signals_path, "clean_segments") #"/srv/local/data/physionet.org/files/chbmit/1.0.0/clean_segments"
