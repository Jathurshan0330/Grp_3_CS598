...
class Pl_LAT_Classification_Freq_VQVAE(pl.LightningModule):
    def __init__(self,
        ...
        self.tokenizer = LaBRAM_VQVAE(in_channels=1,
                        kernel_size =200,
                        stride=200,
...
if __name__ == "__main__":
    ...
    if args.restart_embedding:
        experiment_name = f"masked_modeling_LaBRAM_window_len_200_{args.dataset_name}_restart_embedding_{args.signal_transform}_beta{tokenizer_params['beta']}_LAT_Classification_VQVAE_num_epochs_{training_params['num_epochs']}"
        # experiment_name = f"freq_bin_masking_masked_modeling_temporal_separate_full_freq_window_len_200_{args.dataset_name}_restart_embedding_{args.signal_transform}_beta{tokenizer_params['beta']}_LAT_Classification_VQVAE_num_epochs_{training_params['num_epochs']}"
...
## LaBRAM
    # python LaBRAM_vqvae_tokens_aft_masked_classification.py --dataset_name 'TUEV'  --resampling_rate 200 --vqvae_pretrained_path '/home/jp65/Biosignals_Research/EEG_BPE_Experiments/spectrum_vqvae_experiments/LaBRAM_decoding_task_TUEV_None_FREQ_VQVAE_pretraining_codebook_size_4096_emb_size_64beta0.2/vqvae_last_model.pth'  --masked_pretrained_path '/home/jp65/Biosignals_Research/EEG_BPE_Experiments/spectrum_vqvae_experiments/LaBRAM_masking_masked_modeling_window_len_200_TUEV_restart_embedding_None_beta0.2_LAT_Classification_VQVAE_num_epochs_100'   --gpu '6' --restart_embedding
