...
if __name__ == "__main__":
    ...
    if args.restart_embedding:
        experiment_name = f"LaBRAM_masking_masked_modeling_window_len_200_{args.dataset_name}_restart_embedding_{args.signal_transform}_beta{tokenizer_params['beta']}_LAT_Classification_VQVAE_num_epochs_{training_params['num_epochs']}"
