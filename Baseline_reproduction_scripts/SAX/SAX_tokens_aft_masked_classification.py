...
from models.sax_tokenizer import SAX_Tokenizer
...
class Pl_LAT_Classification_Freq_VQVAE(pl.LightningModule):
    def __init__(self,
        ...
        print('Using SAX')
        self.tokenizer = SAX_Tokenizer(in_channels=1,
                          n_tokens =self.tokenizer_params['code_book_size'],
                          window_size=100)
...
if __name__ == "__main__":
    ...
    if args.restart_embedding:
        experiment_name = f"SAX_masked_modeling_window_len_100_{args.dataset_name}_restart_embedding_LAT_Classification_VQVAE_num_epochs_{training_params['num_epochs']}"
...
# TUEV SAX
    # python SAX_tokens_aft_masked_classification.py --dataset_name 'TUEV' --resampling_rate 200 --masked_pretrained_path '/home/jp65/Biosignals_Research/EEG_BPE_Experiments/spectrum_vqvae_experiments/SAX_window_len_100s_TUEV_restart_embedding_num_epochs_100'   --gpu '3' --restart_embedding