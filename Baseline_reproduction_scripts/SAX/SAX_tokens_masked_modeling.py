...
if __name__ == "__main__":
    ...
    if args.restart_embedding:
        experiment_name = f"SAX_window_len_100s_{args.dataset_name}_restart_embedding_num_epochs_{training_params['num_epochs']}"
...
# TUEV Sax 0.5s
    # python SAX_tokens_masked_modeling.py --dataset_name 'TUEV'  --resampling_rate 200 --gpu '3' --restart_embedding